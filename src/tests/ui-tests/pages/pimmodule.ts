...
export class PimModule extends BasePage {
   ...
   constructor(page: Page) {
      super(page);
      this.addEmployee = this.page.locator(
      ...
      this.employeeName = this.page.locator(
         '//h6[@class="oxd-text oxd-text--h6 --strong"]'
      );
      this.personalInfo = this.page.locator(
         '//h6[normalize-space()="Personal Details"]'
      );
      this.srcEmpName = this.page.locator(
         '(//input[@placeholder="Type for hints..."])[1]'
      );
      this.searchBtn = this.page.locator(
         '//button[@type="submit" and text()=" Search "]'
      );
      this.resultName = this.page.locator(
         '//div[@role="table"]/div[2]/div[1]/div[1]'
      );
      this.checkBox = this.page.locator(
         '(//div[@class="oxd-table-card-cell-checkbox"]//i[@class="oxd-icon bi-check oxd-checkbox-input-icon"])[1]'
      );
      this.deleteBtn = this.page.locator(
         '//button[normalize-space()="Delete Selected"]'
      );
      this.deleteConfirmBtn = this.page.locator(
         '//button[normalize-space()="Yes, Delete"]'
      );
      this.noRecordsFound = this.page.locator(
